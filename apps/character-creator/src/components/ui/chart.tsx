    ...
    <ChartContext.Provider value={{ config }}>
      <div
        ...
        className={cn(
          ...
          // grid lines (no brittle [stroke='#ccc'] selectors)
...
const ChartStyle = ({ id, config }: { id: string; config: ChartConfig }) => {
  ...
  return (
    <style
      // inject --color-<key> variables for both themes
...
// more permissive props to avoid tight coupling to specific Recharts types
...
type TooltipContentProps = React.ComponentProps<"div"> & {
  ...
  labelFormatter?: (value: any, payload?: AnyRecord[]) => React.ReactNode
